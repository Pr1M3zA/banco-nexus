  ...
  return (
    <div className="flex bg-gray-50 min-h-screen font-sans text-slate-900">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-800">Consulta de Cuenta</h1>
          <p className="text-slate-500 text-sm">Ingresa el número de cuenta para consultar la información bancaria.</p>
        </div>
